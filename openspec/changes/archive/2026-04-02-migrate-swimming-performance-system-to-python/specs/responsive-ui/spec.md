...
The system SHALL render all primary admin and public pages in layouts that remain usable on desktop browsers and mobile phone browsers, including pages that show team/group distinctions and share-oriented content.
...
The system SHALL keep core workflows functional across viewport sizes, including navigation, filtering, chart reading, swimmer distinction by team/group, and form submission.
...
- **WHEN** a visitor views charts or team-aware roster cards on a phone-sized viewport
- **THEN** the page adapts chart labels, spacing, and supporting summaries so the progression and swimmer distinctions can still be understood
