...
- Adds a backend service with SQLite persistence, analytics services, and admin/public APIs.
- Adds a Next.js frontend with admin and public experiences, charts, share views, and responsive layouts.
- Introduces stable frontend and backend dependencies for UI, testing, and database access.
