...
PB state, trend payloads, goal progress, and compare series are computed in Go services and returned as ready-to-render API payloads. The frontend should not have to rebuild business logic from raw rows.
